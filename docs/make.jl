...
DocMeta.setdocmeta!(HybridZones, :DocTestSetup, :(using HybridZones); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/alejandromerchan/HybridZones.jl/blob/{commit}{path}#{line}",
    sitename = "HybridZones.jl",
